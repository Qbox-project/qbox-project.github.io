...
This is purely a warning that can be ignored. QBox published resources are actively being worked on to remove dependency on the legacy qbx_core utils module and move to the new qbx_core lib module.
