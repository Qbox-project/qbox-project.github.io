...
If you are receiving this warning then please download the latest release/commit for that resource. With the exception of the following archived resources this dependency has been resolved

- qbx_fitbit (archived)
- qbx_traphouse (archived)
- qbx_tunerchip (archived)
- qbx_crypto (archived)
- qbx_apartments (archived)
- qbx_houses (archived)
- qbx_phone (archived)
